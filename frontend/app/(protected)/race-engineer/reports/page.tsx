        ...
        <div>
          <div className="flex items-center gap-2 mb-1.5 font-mono">
            <span className="sharp-tag bg-cyan-500/10 text-cyan-300 border border-cyan-500/30">
              <FileText size={12} className="text-cyan-400 mr-1" /> Engineering reports
            </span>
            <span className="text-xs text-slate-400">• Team filtered snapshots</span>
          </div>
          <h1 className="text-xl font-semibold tracking-tight text-slate-100">Engineering performance reports</h1>
            ...
            <div className="space-y-4">
              ...
              {selectedReport.data?.summary_stats && (
                <div>
                  ...
                  <pre className="bg-slate-950 p-3 border border-slate-800 text-xs font-mono text-cyan-300 overflow-x-auto">
