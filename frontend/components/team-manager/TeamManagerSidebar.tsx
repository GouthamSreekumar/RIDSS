...
/**
 * TeamManagerSidebar — Fixed left navigation for Team Manager workspace.
    ...
    <aside className="fixed inset-y-0 left-0 z-40 flex w-64 flex-col border-r border-slate-800/60 bg-slate-900">
      ...
      <div className="flex items-center gap-3 border-b border-slate-800/60 px-5 py-4">
        ...
        <div>
          ...
          <p className="text-[10px] text-amber tracking-widest uppercase font-medium">Team Manager</p>
        </div>
      </div>
      ...
      <div className="border-t border-slate-800/60 p-3">
        <div className="mb-2 rounded-lg bg-slate-800/40 px-3 py-2.5">
          ...
          <span className="mt-1 inline-block rounded-sm bg-amber/15 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-widest text-amber ring-1 ring-amber/20">
            Team Manager
          </span>
        </div>
        <button
